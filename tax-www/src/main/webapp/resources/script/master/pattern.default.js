...
requirejs.config({
    ...
    paths: {
        ...
        'lightbox' : 'lightbox-2.9.0/js/lightbox.min',

        'slippry' : 'slippry/slippry.min',

        'socket.io' : 'socket.io/socket.io',

        'INNODEP' : 'vms/INNODEP/INNODEP',
        'VURIX' : 'vms/VURIX/VURIX',
        ...
        'openlayers': 'openlayers-4.4.2/js/ol',
        'proj4': 'proj4js-2.4.3/dist/proj4',
