package egovframework.com.cmn.service;
...
public class EgovProperties {
    ...
    private static final Logger LOGGER = LogManager.getLogger(EgovProperties.class);
    ...
    // 공백 : %20 때문에 치환 처리
    public static final String RELATIVE_PATH_PREFIX = URLDecoder.decode(EgovProperties.class.getResource("").getPath().substring(0, EgovProperties.class.getResource("").getPath().lastIndexOf("com")));
